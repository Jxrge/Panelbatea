...
public class cuerdas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Poligono", "Cuadricula", "Localización", "NumeroCuerdas", "Cuerdasporponer", "Cuerdas de Cria", "Tiempo de cada cuerda de cria", "Total de cuerdas de cria", "Cuerdas de Desdoble", "Tiempo de cada cuerda de desdoble", "Total de cuerdas de desdoble", "Cuerdas para la venta", "Kg para la venta", "TotaldeKg", "PrecioporKG", "Importe", "PrecioconIva", "Precio del iva", "Fecha de la venta", "Total Precio", "Iva total", "Total cuerdas vendidas"
            }
        ));
